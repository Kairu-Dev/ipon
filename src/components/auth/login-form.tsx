  ...
  return (
    <div className="w-full max-w-md flex flex-col gap-12">
      ...
      <div className="flex flex-col items-center gap-1 mt-4">
        <span className="font-label-xs text-label-xs text-outline">Test account for this app</span>
        <span className="font-label-xs text-label-xs text-outline">Email: name@example.com</span>
        <span className="font-label-xs text-label-xs text-outline">Password: 12345678</span>
      </div>
    </div>
  );
}
